...
void rendering::draw_grid(Window_System& window, const i32 x_step, const i32 y_step, const Color color) {
...
void rendering::draw_rect(Window_System& window, const Vec2i coord, const Vec2i rect, const Color color) {
    Vec2i start;
...
void rendering::draw_line(Window_System& window, const Vec2i from, const Vec2i to, const Color color) {
...
void rendering::draw_triangle_wireframe(Window_System& window, const Triangle& triangle, const Color color) {
...
void rendering::draw_triangle_filled(Window_System& window, const Triangle& triangle, const Color color) {
